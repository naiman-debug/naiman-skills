...
- [Skill 1: Project Startup Standardization](skills/project-startup-standardization/README.en.md)
- [Skill 2: Project Day Closeout](skills/project-day-closeout/README.en.md)
- [Skill 3: Bubugao](skills/bubugao/README.en.md)
...
The GitHub main branch has been updated with bilingual introductions, while v0.1.0 remains the current prerelease and its ZIP package retains earlier documentation; skill execution behavior is unchanged.
